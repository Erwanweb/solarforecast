...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if self.ForecastRequest <= now:
            self.ForecastRequest = datetime.now() + timedelta(minutes=1) # make a Call every 15 minutes max
            ...
            if latlon:
                ...
                if SFDatas:
                    ...
                    self.J0WperHRaw = f"{D0H0},{D0H1},{D0H2},{D0H3},{D0H4},{D0H5},{D0H6},{D0H7},{D0H8},{D0H9},{D0H10},{D0H11},{D0H12}"
                ...
                Devices[2].Update(nValue=0, sValue="{}".format(str(self.J0WperHRaw)))
