...
<plugin key="RL-SOLARFORECAST" name="Ronelabs - Solar Forecast plugin" author="Ronelabs" version="0.0.2" externallink="https://ronelabs.com">
    ...
    <params>
        <param field="Mode1" label="Declinaison (ex:0 is horizontal)" width="100px" required="true" default="35"/>
        <param field="Mode2" label="Azimut (-90=E,0=S,90=W)" width="100px" required="true" default="0"/>
        <param field="Mode3" label="PV Plant Power in Kwc (ex: 6.350)" width="200px" required="true" default="3"/>
        <param field="Mode4" label="System lost in %" width="100px" required="false" default="0"/>
        ...
        if self.ForecastRequest <= now:
            ...
            if latlon:
                ...
                if SFDatas:
                    ...
                    # creating raw data list of value
                    self.J0WperHRaw = f"{D1H0},{D1H1},{D1H2},{D1H3},{D1H4},{D1H5},{D1H6},{D1H7},{D1H8},{D1H9},{D1H10},{D1H11},{D1H12},{D1H13},{D1H14},{D1H15},{D1H16},{D1H17},{D1H18},{D1H19},{D1H20},{D1H21},{D1H22},{D1H23}"
...
def SolarForecatAPI(APICall):
    ...
    if not os.path.isfile(jsonFile):
        ...
        Domoticz.Debug("Solar Forcast datas found")
    # Check for ecowatt datas
    with open(jsonFile) as EcoWattStream:
        try:
            SFjsonData = json.load(EcoWattStream)
        except:
